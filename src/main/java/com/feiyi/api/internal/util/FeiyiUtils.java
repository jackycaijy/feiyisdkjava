...
import com.feiyi.api.Constants;
import com.feiyi.api.FeiyiResponse;
import com.feiyi.api.SecretException;
...
import com.feiyi.api.internal.util.json.JSONWriter;
 ...
 */
public abstract class FeiyiUtils {
...
//		return writer.write(object);
	 ...
	 * @return API响应对象
	 */
	public static <T extends FeiyiResponse> T parseResponse(String json, Class<T> clazz) throws ApiException {
    ...
    public static byte[] aesDecrypt(byte[] encryptBytes, byte[] decryptKey) throws SecretException {
        ...
        try {
            ...
            return cipher.doFinal(Base64.decodeBase64(encryptBytes));
        } catch (Exception e) {
            throw new SecretException(e);
        }
    }
